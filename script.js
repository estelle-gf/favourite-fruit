...
let promptOneFact = `User instructions: Generate a short insightful funny fact about ${fruitName}.For example knock knock jokes or a pun. No More that 4 lines of text`
